        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0 text-white">Form Tambah Pegawai</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('master-pegawai.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="NamaPeserta" id="NamaPeserta" value="{{ old('NamaPeserta') }}"
                                class="form-control" required placeholder="Contoh: Andi Wijaya">
                        </div>

                        <div class="mb-3">
                            <label for="AsalUnit" class="form-label">Asal Unit</label>
                            <input type="text" name="AsalUnit" id="AsalUnit" value="{{ old('AsalUnit') }}"
                                class="form-control" placeholder="Contoh: Bagian Keuangan">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Upload gambar tanda tangan (.jpg/.jpeg/.png, opsional).</div>
                            <div id="preview-tandatangan" class="mt-2">
                                @if (old('TandaTangan'))
                                    <img src="{{ old('TandaTangan') }}" alt="Preview Tanda Tangan"
